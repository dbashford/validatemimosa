...
exports.ifExistsFileIncludeWithRegexAndString = function(errors, fld, obj, relTo) {
  return exports.ifExistsFileExcludeWithRegexAndStringWithField(errors, fld, obj, relTo, 'include');
};

exports.ifExistsFileExcludeWithRegexAndString = function(errors, fld, obj, relTo) {
  return exports.ifExistsFileExcludeWithRegexAndStringWithField(errors, fld, obj, relTo, 'exclude');
};

exports.ifExistsFileExcludeWithRegexAndString = function(errors, fld, obj, relTo, includeOrExclude) {
  if (obj[includeOrExclude] !== null && obj[includeOrExclude] !== void 0) {
    return exports.ifExistsFileIncludeExcludeWithRegexAndStringWithField(errors, fld, obj, relTo, includeOrExclude);
  }
};

exports.ifExistsFileIncludeExcludeWithRegexAndStringWithField = function(errors, fld, obj, relTo, includeOrExclude) {
  ...
  if (Array.isArray(obj[includeOrExclude])) {
    ...
    return obj[includeOrExclude] = newIncludeExclude;
  } else {
    errors.push("" + fld + " must be an array");
    return false;
  }
